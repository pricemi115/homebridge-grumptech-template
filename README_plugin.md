...
[Homebridge Template](https://github.com/pricemi115/homebridge-grumptech-template), by [GrumpTech](https://github.com/pricemi115/), is a [Homebridge](https://homebridge.io) dynamic platform plug-in that ......

## Installation

This plug-in is intended to be used with the [homebridge-config-ui-x](https://www.npmjs.com/package/homebridge-config-ui-x) homebridge management tool. If using _homebridge-config-ui-x_, simply search for _homebridge-grumptech-template_ for installation, plug-in management, and configuration.

To install the plugin manually:
<br>_`npm install -g homebridge-grumptech-template`_
...
Refer to the bugs and enhancements listed [here](https://github.com/pricemi115/homebridge-grumptech-template/issues)
## Contributing
